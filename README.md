...
```javascript
import countFalsy from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-count-falsy@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-count-falsy/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/array-base-count-falsy/actions/workflows/test.yml?query=branch:v0.1.1
